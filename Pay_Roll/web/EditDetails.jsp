...
<table style="width:100%">
  ...
  <tr>
     ...
     <td>
        <div class="md-form">
            <input placeholder="Input Employee ID" type="text" id="form5" class="form-control">
        </div>
     </td>
  </tr>
  <tr>
    <td colspan="2" class="text-center">
     <div class="md-form">
        <button class="btn blue-gradient btn-rounded btn-md">Retrieve</button>
     </div>
     </td>
  </tr>
</table>
...
<table style="width:100%">
  <tr>
     ...
     <td>
        <div class="md-form">
            <input placeholder="Input Name" type="text" id="form5" class="form-control">
        </div>
     </td>
  </tr>
  <tr>
     ...
     <td>
        <div class="md-form">
            <input placeholder="Input Contact no" type="text" id="form5" class="form-control">
        </div>
     </td>
  </tr>
  <tr>
     ...
     <td>
        <div class="md-form">
            <input placeholder="Input Email ID" type="text" id="form5" class="form-control">
        </div>
     </td>
  </tr>
  <tr>
  ...
  <tr>
     ...
     <td>
        <div class="md-form">
            <input placeholder="" type="text" id="form5" class="form-control" readonly>
        </div>
     </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
     <td colspan="2" class="text-center">
         <button class="btn btn-outline-warning btn-rounded waves-effect">Update</button>
     </td>
  </tr>
</table>
